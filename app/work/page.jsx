...
const projects = [
	{
		...
		title: "Boca.Ltd Tech",
		description:
			"Boca Ltd. is your destination for smart, portable gadgets designed to enhance productivity and modern living. Based in the UK and priced in GBP, the store features curated categories such as New Arrivals, Essentials (like grooming tools, security devices, printers, scanners, health monitors), and Gadgets (including laptop and mobile phone stands). Whether you're upgrading your workspace or looking for tech-savvy essentials, Boca Ltd. offers practical, well-designed solutions to streamline your daily routine.",
		stack: [{ name: "Shopify" }],
		image: "/images/work/project-1.png",
		live: "https://shop.bocaltd.com/",
		github: "",
	},
	// {
	// 	num: "02",
	...
	// },
	{
		...
		description:
			"Boost Business Hub is a Nigerian tech education and consulting company that provides hands-on training, mentorship, and corporate upskilling programs to bridge the digital skills gap and empower future tech leaders.",
		stack: [
			{ name: "Html 5" },
			{ name: "Tailwind Css" },
			{ name: "Javascript" },
	...
	},
	{
		...
		title: "getLinked",
		description:
			"An innovation-driven event designed to ignite creativity and problem-solving among technologists, designers, and visionaries. Participants are encouraged to transform their ideas into real-world solutions, pushing the boundaries of modern technology.",
		stack: [
			{ name: "Html 5" },
			{ name: "Css 3" },
			{ name: "Vite" },
	...
	},
	{
		...
		title: "Kelsbot",
		description:
			"KelsBot is a friendly and responsive chatbot. Designed to provide quick replies and simulate basic conversations, KelsBot offers a clean, intuitive interface using Tailwind CSS. Whether you're greeting it or asking for help, KelsBot is ready to assist with a touch of personality and simplicity.",
...
category: "Fullstack",
		title: "Quiz Mentor",
		description:
			"QuizMentor is a next-generation, AI-powered quiz platform designed to transform how teachers assess and how students learn. ",
		stack: [
			{ name: "Html 5" },
			{ name: "Css 3" },
			{ name: "Typescript" },
	...
	},
	{
		...
		description:
			"Rock, Paper, Scissors is a classic game where players choose between three options: rock, paper, or scissors. The game is designed with a sleek interface using Tailwind CSS and React, providing an engaging user experience. Players can easily select their choice and see the outcome of each round in real-time.",
		stack: [
			{ name: "Html 5" },
			{ name: "Tailwind Css" },
			{ name: "Javascript" },
	...
	},
	{
		...
		title: "ApplyForU",
		description:
			"ApplyForU is a comprehensive job application platform designed to streamline the job search process. It allows users to create profiles, upload resumes, and apply for jobs with ease. The platform features a user-friendly interface built with Next.js and Tailwind CSS, ensuring a smooth experience for job seekers.",
