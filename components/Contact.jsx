	...
	return (
		<div>
			...
			<motion.section
				...
				className="py-6 px-6 pb-10 relative mb-20 xl:mb-10">
						...
						<div className="xl:w-[50%] order-2 xl:order-none">
							<form
								...
								<p className="text-sm xl:text-md text-white/60 ">
									Achieve your goals with collaborative expertise. From
									innovative designs to effective strategies, we bring your
									vision to life and ensure lasting success.
								</p>
								{/* input */}
