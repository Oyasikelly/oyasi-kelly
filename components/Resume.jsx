...
export default function Resume() {
	return (
		<motion.div
			...
			className="min-h-[80vh] flex items-center justify-center px-14 xl:px-0 py-12 xl:py-0 my-20 xl:my-10 h-full">
											...
											<li
												...
												<ul className="w-auto pb-4">
													{item.role.map((rol, idx) => (
														<li
															key={idx}
															className="flex items-center gap-3 mt-4 self-start">
															<span className="w-[15px] h-[6px] rounded-full bg-accent self-start"></span>
															<span className="self-start -mt-2 text-white/40">
																{rol}
															</span>
														</li>
													))}
